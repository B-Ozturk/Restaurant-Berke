...
// This mail sends an email when a member places a order
function sendOrderMail(){
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Bestelling | Restaurant Berke';
        $mail->Body    = 'Beste '. $toName .',<br><br>U heeft op een bestelling geplaatst op'. $timeStamp .
            '<br>Bestelling:' . var_export($shoppingCart);
